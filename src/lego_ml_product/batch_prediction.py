...
Feature Store 1) Predictions are scored utilizing the centralized Feature Store via FeatureEngineeringClient.
'''
...
def main() -> None:
    ...
    try:
        ...
        logger.info(f"Loading features from Feature Engineering Client: {fully_qualified_feature_table_name}")
        dataframe = fe.read_table(name=fully_qualified_feature_table_name)
    except Exception:
